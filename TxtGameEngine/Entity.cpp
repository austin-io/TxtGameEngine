...
txt::Game::Entity::Entity(int hpMax, int ac, int lvl, int gold, int str, int dex, int con, int intel, int wis, int cha, std::string name, std::string description)
